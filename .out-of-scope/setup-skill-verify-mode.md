# Verify/Check Mode for `setup-evantoor-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-evantoor-skills`.
...
- #106 — Feature request: verify/check mode for setup-evantoor-skills
