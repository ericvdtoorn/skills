...
- evantoor core workflow: `grill-me`, `grill-with-docs`, `to-spec`, `to-tickets`, `triage`, `tdd`, `diagnosing-bugs`, `improve-codebase-architecture`, `zoom-out`, `prototype`, `handoff`, `writing-great-skills`, `caveman`, `gitmoji-commits`, `comment-style`
- doc fetchers / general tooling: `context7` (MCP), and similar library-docs lookups

`tdd`, `diagnosing-bugs`, `to-tickets`, `triage` are language-agnostic by design — a repo being Rust or Python is **not** a reason to disable them.
